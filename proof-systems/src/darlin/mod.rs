...
use poly_commit::{ ipa_pc::{
    ...
    Commitment
}, PolynomialCommitment, DomainExtendedPolynomialCommitment, DomainExtendedCommitment, QuerySet, LabeledCommitment, Evaluations};
use marlin::{
    Marlin,
        ...
        D:  Digest + 'static,
{
    ...
    {
        let srs_g1 = Marlin::<G1, DomainExtendedPolynomialCommitment<G1, InnerProductArgPC<G1, D>>, D>::universal_setup(
            num_constraints,
            num_variables,
            num_non_zero,
            zk
        ...
        let srs_g2 = Marlin::<G2, DomainExtendedPolynomialCommitment<G2, InnerProductArgPC<G2, D>>, D>::universal_setup(
            num_constraints,
            num_variables,
            num_non_zero,
            zk
    ...
    pub fn index<C: PCDCircuit<G1>>(
        ...
        config:   C::SetupData,
            ...
            FinalDarlinProverKey<G1, DomainExtendedPolynomialCommitment<G1, InnerProductArgPC<G1, D>>>,
            FinalDarlinVerifierKey<G1, DomainExtendedPolynomialCommitment<G1, InnerProductArgPC<G1, D>>>,
        ), FinalDarlinError>
    {
        let c = C::init(config);
    ...
    pub fn prove<C>(
        index_pk:         &FinalDarlinProverKey<G1, DomainExtendedPolynomialCommitment<G1, InnerProductArgPC<G1, D>>>,
            ...
            C: PCDCircuit<G1, SystemInputs = FinalDarlinDeferredData<G1, G2>>,
    {
        ...
        let proof = Marlin::<G1, DomainExtendedPolynomialCommitment<G1, InnerProductArgPC<G1, D>>, D>::prove(
