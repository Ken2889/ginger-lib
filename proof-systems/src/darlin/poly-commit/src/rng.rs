...
pub trait FiatShamirRng: RngCore + Sized {
    /// Internal State
    type State: Clone;
...
#[derive(Default)]
/// Implementation of `FiatShamirRngSeed` for `FiatShamirChaChaRng`.
/// Output type of the seed is a byte array.
/// To avoid cross-protocol attacks (see https://github.com/HorizenLabs/poly-commit/issues/22),
/// the number of elements of the seed and their individual length will be part of the seed itself.
