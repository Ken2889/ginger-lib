...
use algebra::{field_new, fields::tweedle::Fr as TweedleFr, BigInteger256 as BigInteger, Field};
use primitives::{crh::TweedleFrPoseidonParameters, PoseidonParameters};
...
impl DensityOptimizedPoseidonQuinticSBoxParameters<TweedleFr, TweedleFrPoseidonParameters> for TweedleFrDensityOptimizedPoseidonParameters {
    ...
    const ALPHA: &'static [&'static[TweedleFr; 5]; 60] = &[
        &[
            field_new!(
                TweedleFr,
                BigInteger([
    ...
    const BETA: &'static [&'static[TweedleFr; 5]; 60] = &[
        &[
            field_new!(
                TweedleFr,
                BigInteger([
    ...
    const GAMMA: &'static [&'static[TweedleFr; 5]; 60] = &[
        &[
            field_new!(
                TweedleFr,
                BigInteger([
    ...
    const LC: &'static [&'static[TweedleFr; 7]; 5] = &[
        &[
            field_new!(
                TweedleFr,
                BigInteger([
