...
pub type TEEd25519 = twisted_edwards_extended::TEExtended<Ed25519Parameters>;
pub type SWEd25519 = short_weierstrass_jacobian::Jacobian<Ed25519Parameters>;
...
impl FromStr for TEEd25519 {
    ...
    fn from_str(mut s: &str) -> Result<Self, Self::Err> {
        ...
        let point: TEEd25519 = twisted_edwards_extended::AffineRep::new(point[0], point[1]).into();
