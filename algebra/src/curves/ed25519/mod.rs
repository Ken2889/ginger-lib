...
pub type Ed25519TEExtended = twisted_edwards_extended::TEExtended<Ed25519Parameters>;
pub type Ed25519Jacobian = short_weierstrass_jacobian::Jacobian<Ed25519Parameters>;
...
impl FromStr for Ed25519TEExtended {
    type Err = ();
    ...
    fn from_str(mut s: &str) -> Result<Self, Self::Err> {
        ...
        let point = Ed25519TEExtended::from_affine(&<Ed25519TEExtended as Curve>::AffineRep::new(
            point[0], point[1],
        ));
