...
}, /*fields::secp256k1::Fr, */groups::tests::group_test, FromBytes/*, SemanticallyValid*/};
// use hex_literal::hex;
...
fn test_secp256k1_group() {
    ...
    let a: Secp256k1Jacobian = rng.gen();
    let b: Secp256k1Jacobian = rng.gen();
    group_test(a, b);
}

#[test]
fn test_secp256k1_generator() {
    let generator = Secp256k1Jacobian::prime_subgroup_generator();
    assert!(generator.is_on_curve());
    assert!(generator.is_in_correct_subgroup_assuming_on_curve());
}

fn to_internal_repr(mut x: Vec<u8>, mut y: Vec<u8>, mut z: Vec<u8>) -> Secp256k1Jacobian {
    ...
    Secp256k1Jacobian::read(&x[..]).unwrap()
}
...
//     const ADD_TEST_VECTORS: &[([u8; 32], [u8; 32], [u8; 32])] = &[
//         (
...
//     ];
//
//     let gen = Secp256k1Jacobian::prime_subgroup_generator();
//     let mut curr_point = gen;
//
//     for (i, (x, y, z)) in ADD_TEST_VECTORS.iter().enumerate() {
//         let test_point = to_internal_repr(x.to_vec(), y.to_vec(), z.to_vec());
//         assert!(
//             test_point.is_valid(),
...
//     use std::ops::Mul;
//
//     pub const MUL_TEST_VECTORS: &[([u8; 32], [u8; 32], [u8; 32], [u8; 32])] = &[
//         (
...
//     let gen = Secp256k1Jacobian::prime_subgroup_generator();
//
//     for (i, (scalar, x, y, z)) in MUL_TEST_VECTORS.iter().enumerate() {
//         let test_point = to_internal_repr(x.to_vec(), y.to_vec(), z.to_vec());
//         assert!(
//             test_point.is_valid(),
//             "Validity test failed for point {}",
